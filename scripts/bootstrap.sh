...
To build later:
    ...
    # env-prefix shorthand "CI_ETL_TAG=v0.3.8a cmake ..." used to be enough
    ...
    VFLAGS=(-DCI_ETL_TAG=v0.3.8a -DCI_ETL_DESCRIBE=v0.3.8a)
    ...
    # Linux x86_64 + the multi-arch vanguard_v0.3.8a.pk3 the server hands out.
...
# ETLVersion.cmake so the resulting pk3 is named vanguard_v0.3.8a.pk3 instead
# of falling back to the imported ETLEGACY_VERSION (2.83.x).
# See docs/RELEASE_PROCESS.md for the full bump checklist.
export CI_ETL_TAG="${VANGUARD_VERSION:-v0.3.8a}"
