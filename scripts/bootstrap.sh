...
To build later:
    ...
    # Linux x86_64 + the multi-arch vanguard_v0.2.0.pk3 the server hands out.
    ...
    CI_ETL_TAG=v0.2.0 CI_ETL_DESCRIBE=v0.2.0 cmake -B build \\
...
# ETLVersion.cmake so the resulting pk3 is named vanguard_v0.2.0.pk3 instead
# of falling back to the imported ETLEGACY_VERSION (2.83.x).
# See docs/RELEASE_PROCESS.md for the full bump checklist.
export CI_ETL_TAG="${VANGUARD_VERSION:-v0.2.0}"
