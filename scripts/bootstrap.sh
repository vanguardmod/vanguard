...
To build later:
    ...
    # env-prefix shorthand "CI_ETL_TAG=v0.4.1 cmake ..." used to be enough
    ...
    VFLAGS=(-DCI_ETL_TAG=v0.4.1 -DCI_ETL_DESCRIBE=v0.4.1)
    ...
    # Linux x86_64 + the multi-arch vanguard_v0.4.1.pk3 the server hands out.
...
# ETLVersion.cmake so the resulting pk3 is named vanguard_v0.4.1.pk3 instead
# of falling back to the imported ETLEGACY_VERSION (2.83.x).
# See docs/RELEASE_PROCESS.md for the full bump checklist.
export CI_ETL_TAG="${VANGUARD_VERSION:-v0.4.1}"
