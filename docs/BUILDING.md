...
`build/vanguard/vanguard_v0.4.1.pk3` as part of the Linux build's `ALL`
...
Override the version by reconfiguring with `CI_ETL_TAG=v0.4.1
CI_ETL_DESCRIBE=v0.4.1 cmake -B build …` — these env vars are upstream's
