...
`build/vanguard/vanguard_v0.3.7.pk3` as part of the Linux build's `ALL`
...
Override the version by reconfiguring with `CI_ETL_TAG=v0.3.7
CI_ETL_DESCRIBE=v0.3.7 cmake -B build …` — these env vars are upstream's
